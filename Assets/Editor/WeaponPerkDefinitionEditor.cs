...
[CustomEditor(typeof(WeaponPerkDefinition))]
public class WeaponPerkDefinitionEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("perkName"));
    ...
    void DrawStatTargetPopup(SerializedProperty weaponTypeProp)
    {
        ...
        var weaponType = (ECarWeaponType)weaponTypeProp.enumValueIndex;
        var allowed = CarWeaponStatTargetMap.GetAllowed(weaponType);
        ...
        var currentValue = (ECarWeaponStatTarget)statTargetProp.enumValueIndex;
